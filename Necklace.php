...
$sql_Necklace = "SELECT * from cart as c inner join products as p on p.id = c.fk_product_id";
$cart_product = $conn->query($sql_Necklace);
                                                ...
                                                <ul class="mega_menu">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="WomenRing.php">Rings</a></li>
                                                    ...
                                                    <li>
                                                        <a href="#">Other</a>
                                                        <ul>
                                                            <li><a href="Platinium.php">Platinium</a></li>
                                                            <li><a href="Silver.php">Silver</a></li>
                                                            <li><a href="Coins.php">Coins</a></li>
                                                            <li><a href="GigtCart.php">Gift Card</a></li>
                                                        </ul>
                                                    </li>
                            ...
                            <div class="product_tab_button">
                                <ul class="nav" role="tablist">
                                    <li>
                                        ...
                                        aria-controls="featured" aria-selected="true">Necklace</a>
                                    </li>
                                    <li>
                                    </ul>
                            </div>
...
$sql_Necklace = "SELECT * from products as p inner join map_products_category as mpc on mpc.fk_product_id = p.id inner join category as c on c.id = mpc.fk_category_id WHERE c.name = 'Necklace';
";
$Necklace_products = $conn->query($sql_Necklace);
            ...
            <div class="col-12">
                <div class="product_area">
                    <div class="product_tab_button">
                        <ul class="nav" role="tablist">
                            <li>
                                <a href="Platinum" data-toggle="tab" role="tab" aria-controls="Giftcart"
                        ...
                        <!-- Featured Products -->
                        <div class="tab-pane fade show active" id="Neclack" role="tabpanel">
                            <div class="product_container">
                            <div class="card">
                                <div class="row">
                                    <?php while ($row = mysqli_fetch_assoc($Necklace_products)) { ?>
                                ...
                                <div class="simple_product">
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Women/Necklace2.jpeg" alt="Necklace"></a>
                                        </div>
                                    ...
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Women/Necklace6.jpg" alt="Necklace"></a>
                                        </div>
                                        <div class="simple_product_content">
                                            <div class="tag_cate">
                                                <a href="#">Women,</a>
                                    ...
                                    <div class="tab-content product-details-large">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Women/Necklace5.jpg" alt="Necklace"></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="tab3" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Women/Necklace7.jpg" alt="Necklace"></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Women/Necklace8.jpg" alt="Necklace"></a>
                                            </div>
                                        </div>
                                    </div>
