...
$sql_Platinum = "SELECT * from cart as c inner join products as p on p.id = c.fk_product_id";
$cart_product = $conn->query($sql_Platinum);
                                        ...
                                        <ul>
                                                ...
                                                <ul class="mega_menu">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="WomenPendants.html">Pendant</a></li>
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub_menu pages">
                                                    ...
                                                    <li><a href="Rings.php">Ring</a></li>
                                                    <li><a href="Bracelet.php">Bracelet</a></li>
                                                    <li><a href="Necklace.html">Necklace Set</a></li>
                                                </ul>
                                            </li>
                            ...
                            <div class="product_tab_button">
                                <ul class="nav" role="tablist">
                                    <li>
                                        ...
                                        aria-controls="featured" aria-selected="true">Platinium</a>
                                    </li>
                                    <li>
                                    </ul>
                            </div>
...
$sql_Platinum = "SELECT * from products as p inner join map_products_category as mpc on mpc.fk_product_id = p.id inner join category as c on c.id = mpc.fk_category_id WHERE c.name = 'Platinum';
";
$Platinum_products = $conn->query($sql_Platinum);
            ...
            <div class="col-12">
                <div class="product_area">
                    <div class="product_tab_button">
                        <ul class="nav" role="tablist">
                            <li>
                                <a href="Platinum" data-toggle="tab" role="tab" aria-controls="Platinum"
                    ...
                    <div class="tab-content ">
                        <!-- Featured Products -->
                        <div class="tab-pane fade show active" id="Platinum" role="tabpanel">
                            <div class="product_container">
                            <div class="card">
                                <div class="row">
                                    <?php while ($row = mysqli_fetch_assoc($Platinum_products)) { ?>
                                ...
                                <div class="simple_product">
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Platinum/Platinum3.jpg" alt="Chain,Platinium"></a>
                                        </div>
                                    ...
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Platinum/Platinum5.jpg" alt="Chain,Platinium"></a>
                                        </div>
                                        <div class="simple_product_content">
                                            <div class="tag_cate">
                                                <a href="#">Man,</a>
                                    ...
                                    <div class="tab-content product-details-large">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Platinum/Platinum1.jpeg" alt="Chain,Platinium"></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Platinum/Platinum2.jpg" alt="Chain,Platinium"></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Platinum/Platinum4.jpg" alt="Chain,Platinium"></a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <li>
                                                <a href="#tab1" class="nav-link active" data-toggle="tab" role="tab"
                                                    aria-controls="tab1" aria-selected="false"><img
                                                        src="img/Platinum/Platinum1.jpeg" alt="Chain,Platinium"></a>
                                            </li>
                                            <li>
                                                <a href="#tab2" class="nav-link" data-toggle="tab" role="tab"
                                                    aria-controls="tab2" aria-selected="false"><img
                                                        src="img/Platinum/Platinum2.jpg" alt="Chain,Platinium"></a>
                                            </li>
                                            <li>
                                                <a href="#tab3" class="nav-link button_three" data-toggle="tab"
                                                    role="tab" aria-controls="tab3" aria-selected="false"><img
                                                        src="img/Platinum/Platinum3.jpg" alt="Chain,Platinium"></a>
                                            </li>
                                            <li>
                                                <a href="#tab4" class="nav-link" data-toggle="tab" role="tab"
                                                    aria-controls="tab4" aria-selected="false"><img
                                                        src="img/Platinum/Platinum4.jpg" alt="Chain,Platinium"></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
