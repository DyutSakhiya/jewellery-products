...
$sql_Gemstone = "SELECT * from cart as c inner join products as p on p.id = c.fk_product_id";
$cart_product = $conn->query($sql_Gemstone);
                            ...
                            <div class="product_tab_button">
                                <ul class="nav" role="tablist">
                                    <li>
                                        ...
                                        aria-controls="featured" aria-selected="true">Gemstone</a>
                                    </li>
                                    <li>
                                    </ul>
                                </div>
...
$sql_Gemstone = "SELECT * from products as p inner join map_products_category as mpc on mpc.fk_product_id = p.id inner join category as c on c.id = mpc.fk_category_id WHERE c.name = 'Gemstone';
";
$Gemstone_products = $conn->query($sql_Gemstone);
            ...
            <div class="col-12">
                <div class="product_area">
                    <div class="product_tab_button">
                        <ul class="nav" role="tablist">
                            <li>
                                <a href="Platinum" data-toggle="tab" role="tab" aria-controls="Gemstone"
                        ...
                        <!-- Featured Products -->
                        <div class="tab-pane fade show active" id="Gemstone" role="tabpanel">
                            <div class="product_container">
                            <div class="card">
                                <div class="row">
                                    <?php while ($row = mysqli_fetch_assoc($Gemstone_products)) { ?>
                                ...
                                <div class="simple_product">
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Men/Gemstone1.jpeg" alt="Chain,Pendant"></a>
                                        </div>
                                    ...
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Men/Gemstone2.jpg" alt="Chain,Pendant"></a>
                                        </div>
                                        <div class="simple_product_content">
                                            <div class="tag_cate">
                                                <a href="#">Man,</a>
                                ...
                                <div class="modal_tab">
                                    <div class="tab-content product-details-large">
                                        ...
                                        <div class="tab-pane fade" id="tab3" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Men/Gemstone3.jpg" alt="Chain,Pendant"></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Men/Gemstone4.jpg" alt="Chain,Pendant"></a>
                                            </div>
                                        </div>
                                    </div>
