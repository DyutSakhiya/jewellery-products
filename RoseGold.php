...
$sql_RoseGold = "SELECT * from cart as c inner join products as p on p.id = c.fk_product_id";
$cart_product = $conn->query($sql_RoseGold);
                            ...
                            <div class="product_tab_button">
                                <ul class="nav" role="tablist">
                                    <li>
                                        ...
                                        aria-controls="featured" aria-selected="true">Rose Gold</a>
                                    </li>
                                    <li>
                                    </ul>
                            </div>
...
$sql_RoseGold = "SELECT * from products as p inner join map_products_category as mpc on mpc.fk_product_id = p.id inner join category as c on c.id = mpc.fk_category_id WHERE c.name = 'RoseGold';
";
$RoseGold_products = $conn->query($sql_RoseGold);
            ...
            <div class="col-12">
                <div class="product_area">
                    <div class="product_tab_button">
                        <ul class="nav" role="tablist">
                            <li>
                                <a href="Platinum" data-toggle="tab" role="tab" aria-controls="RoseGold"
                        ...
                        <!-- Featured Products -->
                        <div class="tab-pane fade show active" id="RoseGold" role="tabpanel">
                            <div class="product_container">
                            <div class="card">
                                <div class="row">
                                    <?php while ($row = mysqli_fetch_assoc($RoseGold_products)) { ?>
                                ...
                                <div class="simple_product">
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Rosr Gold/Rose Gold1.jpeg" alt=""></a>
                                        </div>
                                    ...
                                    <div class="simple_product_items">
                                        <div class="simple_product_thumb">
                                            <a href="#"><img src="img/Rosr Gold/Rose Gold2.jpeg" alt=""></a>
                                        </div>
                                        <div class="simple_product_content">
                                            <div class="tag_cate">
                                                <a href="#">Man,</a>
                                ...
                                <div class="modal_tab">
                                    <div class="tab-content product-details-large">
                                        ...
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Rosr Gold/Rose Gold3.jpeg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab3" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Rosr Gold/Rose Gold5.png" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="img/Rosr Gold/Rose Gold7.jpeg" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
